...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[600px] md:min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0" style={{ background: 'linear-gradient(90deg, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.4))' }} />
      
      <div className="container relative z-10 mx-auto px-4 py-24 md:py-32">
        <div className="max-w-3xl">
          <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight" style={{ color: 'hsl(40 78% 95%)', textShadow: '2px 2px 8px rgba(0,0,0,0.4)' }}>
            A MARMORARIA COM O ACABAMENTO MAIS IMPECÁVEL DE SÃO PAULO
          </h1>
          
          <p className="font-sans text-lg md:text-xl mb-8 leading-relaxed" style={{ color: 'hsl(40 40% 93%)' }}>
