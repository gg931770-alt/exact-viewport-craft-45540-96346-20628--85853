    ...
    <section className="relative min-h-[600px] md:min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 py-24 md:py-32">
        <div className="max-w-3xl mx-auto md:mx-0">
          <h1
            className="font-serif text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-center md:text-left"
            style={{
              color: 'hsl(40 78% 95%)',
              textShadow: '2px 2px 8px rgba(0,0,0,0.4)'
            }}
          >
            A MARMORARIA COM O ACABAMENTO MAIS IMPECÁVEL DE CAMPINAS
          </h1>

          <p
            className="font-sans text-lg md:text-xl mb-8 leading-relaxed text-center md:text-left"
            style={{
              color: 'hsl(40 40% 93%)'
            }}
          >
          ...
          <div className="flex flex-col gap-4 justify-center md:justify-start items-center md:items-start">
            <Button
              variant="premium"
              size="lg"
              className="text-base md:text-lg shadow-[0_4px_20px_hsl(var(--primary)/0.35)] hover:shadow-[0_6px_30px_hsl(var(--primary)/0.5)] transition-shadow duration-300"
              onClick={openPopup}
            >
              FAÇA SEU ORÇAMENTO
            </Button>
            <Button
              ...
              size="default"
              asChild
              className="text-cream-light hover:text-white hover:bg-white/10 border border-cream-light/30"
            >
              <a href="#contato">
                NOSSA LOCALIZAÇÃO
              </a>
